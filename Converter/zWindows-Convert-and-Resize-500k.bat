...
:: 1000 K 64 Bit
::ffmpeg.exe -i %file% -filter:v "scale='min(1280,iw)':min'(800,ih)':force_original_aspect_ratio=decrease,pad=1280:800:(ow-iw)/2:(oh-ih)/2" -b:v 1000K -maxrate 1000K -minrate 1000K -b:a 64k %filename%.webm
