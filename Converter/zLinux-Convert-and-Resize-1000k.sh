...
do
# 500 K 64 Bit
#ffmpeg -i $file -filter:v "scale='min(1280,iw)':min'(800,ih)':force_original_aspect_ratio=decrease,pad=1280:800:(ow-iw)/2:(oh-ih)/2" -b:v 500K -maxrate 500K -minrate 500K -b:a 64k "$file".webm
# 1000 K 64 Bit
